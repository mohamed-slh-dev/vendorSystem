...
class CreateDailyShortsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('daily_shorts', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('remainging_quantity')->nullable();
    ...
    {
        Schema::dropIfExists('daily_shorts');
    }
}
