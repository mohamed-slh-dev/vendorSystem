                          ...
                          @endphp   
                           ...
                           @foreach ($ship->shipmentItmes as $item)
                            ...
                            @endphp
                                 ...
                                 {{-- shipment rows --}}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#update-item-{{$item->id}}">نعديل البيان </button>
                                ...
                                @foreach ($item->itemSells->sortBy('updated_at') as $sell)
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-4 mb-20">
                        ...
                        <input type="number" required id="number" value="{{$ship->number}}" name="number" class="form-control" >
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mb-20">
                        ...
                        <input type="number" id="damaged" name="damaged" min="0" value="{{$sell->damaged}}" class="form-control" >
                    </div>
