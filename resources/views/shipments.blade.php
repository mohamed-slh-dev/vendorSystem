                    ...
                    <div class="box-head row">
                        ...
                        <div class="col-sm-3 mt-3">
                            <button class="btn btn-success" data-toggle="modal"
                                data-target="#add-product-shipment-{{ $ship->id }}">إضافة بيان</button>

                        </div>

                        <div class="col-sm-3 mt-3">
                            <button class="btn btn-primary" data-toggle="modal"
                                data-target="#update-shipment-{{ $ship->id }}">تعديل الإرسالية</button>

                        </div>


                        <div class="col-sm-3 mt-3">
                            <button class="btn button-warning shipment-assign-id" data-toggle="modal"
                                data-target="#add-shipment" value="{{ $ship->id }}">اضافة منصرفات </button>

                        </div>

                        <div class="col-sm-3 mt-3">
                            <button class="btn btn-danger shipment-delete-assign-id" data-toggle="modal"
                                data-target="#delete-shipment" value="{{ $ship->id }}"> حذف الإرسالية </button>
                                ...
                                @foreach ($ship->shipmentItmes as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" data-toggle="modal"
                                                data-target="#update-item-{{ $item->id }}">تعديل البيان </button>

                                        </td>

                                        <td>

                                            <button class="btn btn-danger item-delete-assign-id" data-toggle="modal"
                                                data-target="#delete-item" value="{{ $item->id }}">حذف البيان </button>

                                        </td>

                                        <td>
                                            <button @if ($item->remaining_quantity <= 0) disabled @endif
                                                class="btn btn-success selling-assign-id" data-toggle="modal"
                                                data-target="#add-selling" value="{{ $item->id }}">اضافة مبيعات</button>
                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background: #fdfd62;">
                                                ...
                                                <button class="btn btn-warning" data-toggle="modal"
                                                    data-target="#update-sell-{{ $sell->id }}">تعديل المبيعات </button>

                                            </td>

                                            <td style="background: #fdfd62;">

                                                <button class="btn btn-danger delete-assign-id" data-toggle="modal"
                                                    data-target="#delete-sell" value="{{ $sell->id }}">حذف المبيعات
                                                </button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4 mb-20">
                                ...
                                <input type="number" required id="number" min="0" name="number"
                                    class="form-control">
                            </div>
                            ...
                            <div class="col-12 mb-20 row">
                                ...
                                <div class="col-sm-3 mb-20">
                                    ...
                                    <input type="number" required id="quantity" name="b_quantity[]"
                                        class="form-control">
                                </div>

                                <div class="col-sm-3 mb-20">
                                    <label for="jord_price"> سعر الفاتورة (بالأردني)</label>
                                    <input type="number" required id="jord_price" name="b_price[]" class="form-control"
                                        min="0" value="0" step=".001">
                                </div>

                                <div class="col-sm-3 mb-20">
                                    <label for="sar_price"> سعر الفاتورة (بالريال)</label>
                                    <input type="number" required id="sar_price" name="sar_price[]"
                                        class="form-control" min="0" value="0" step=".001">
                                </div>
                    ...
                    <form action="{{ route('updateShipment') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4 mb-20">
                                    <label for="number"> الرقم</label>
                                    <input type="text" required id="number" min="0"
                                        value="{{ $ship->number }}" name="number" class="form-control">
                                </div>

                                <div class="col-sm-4 mb-20">
                                    <label for="supplier"> المورد</label>
                                    <input type="text" required id="supplier" name="supplier"
                                        value="{{ $ship->supplier }}" class="form-control">
                                </div>
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="date" id="date" required name="date"
                                        value="{{ $ship->date }}" class="form-control">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="text" required id="client" name="client"
                                        value="{{ $sell->client }}" class="form-control">
                                </div>

                                <div class="col-sm-4 mb-20">
                                    <label for="date"> التاريخ</label>
                                    <input type="date" id="date" name="date" value="{{ $sell->date }}"
                                        class="form-control">
                                </div>
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="number" required id="selling_quantity" min="0"
                                        value="{{ $sell->quantity }}" name="selling_quantity" class="form-control">
                                </div>

                                <div class="col-sm-4 mb-20">
                                    <label for="damaged"> التالف</label>
                                    <input type="number" id="damaged" name="damaged" value="{{ $sell->damaged }}"
                                        class="form-control">
                                </div>
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="number" id="quantity" name="price" required class="form-control"
                                        value="{{ $sell->price }}" min="0" step=".001">
                                </div>
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="text" id="bill" name="bill"
                                        value="{{ $sell->bill_number }}" class="form-control">
                                </div>
                    ...
                    <form action="{{ route('updateItem') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-20">
                                    <label for="quantity"> الكمية</label>
                                    <input type="number" required id="quantity" min="0" name="quantity"
                                ...
                                <div class="col-sm-4 mb-20">
                                    ...
                                    <input type="number" required id="remaining_quantity" min="0"
                                        name="remaining_quantity" value="{{ $item->remaining_quantity }}"
                                        class="form-control">
                                </div>

                                <div class="col-sm-4 mb-20">
                                    <label for="jord_price"> سعر الفاتورة</label>
                                    <input type="number" required id="jord_price" name="price"
                                        value="{{ $item->invoice_price }}" class="form-control" min="0"
                                        value="0" step=".001">
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-20">
                                <label for="selling_quantity"> الكمية المباعة</label>
                                <input type="number" required id="selling_quantity" min="0"
                                    name="selling_quantity" class="form-control">
                            </div>

                            <div class="col-sm-4 mb-20">
                                <label for="damaged"> التالف</label>
                                <input type="number" id="damaged" name="damaged" min="0" value="0"
                                    class="form-control">
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-20">
                                ...
                                <input type="text" id="customs" name="customs" min="0" value="0"
                                    step=".001" class="form-control ">
                            </div>

                            <div class="col-sm-6 mb-20">
                                <label for="customs"> الشحن</label>
                                <input type="text" id="customs" name="delivery" min="0" value="0"
                                    step=".001" class="form-control ">
                            </div>
                            ...
                            <div class="col-sm-6 mb-20">
                                ...
                                <input type="text" id="others" name="jordan" min="0" value="0"
                                    step=".001" class="form-control ">
                            </div>
                            ...
                            <div class="col-sm-6 mb-20">
                                ...
                                <input type="text" id="others" name="others" min="0" value="0"
                                    step=".001" class="form-control ">
                            </div>
