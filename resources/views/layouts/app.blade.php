...
<head>
 ...
 <link rel="stylesheet" href="{{ asset('assets/fonts/noto/stylesheet.css') }}">
                                ...
                                <ul class="header-notification-area">
                                    ...
                                    <li class="adomx-dropdown col-auto">
                                        ...
                                        <div class="adomx-dropdown-menu dropdown-menu-user">
                                            <div class="head">
                                                <h5 class="name"><a href="#"> {{ session()->get('name') }} </a>
                                                </h5>
                                            ...
                                            <div class="body">
                                                <ul>
                                                    ...
                                                    <li><a href="{{ route('logout') }}"><i
                                                                class="zmdi zmdi-lock-open"></i>تسجيل الخروج</a></li>
                                                </ul>
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        @if (session()->get('user_id') == 1)
                            <li><a href="{{ route('dashboard') }}"><i class="ti-home"></i> <span>الرئيسية</span></a>
                            </li>

                            <li><a href="{{ route('products') }}"><i class="fa fa-cubes"></i> <span>البيان</span></a>
                            </li>

                            <li><a href="{{ route('shipments') }}"><i class="fa fa-tasks"></i>
                                    <span>الإرساليات</span></a></li>

                            {{-- <li><a href="{{route('notes')}}"><i class="fa fa-sticky-note"></i> <span>دفتر الملاحظات</span></a></li> --}}

                            <li><a href="{{ route('dailySells') }}"><i class="fa fa-sticky-note"></i> <span> المبيعات
                                        اليومية</span></a></li>

                            <li><a href="{{ route('dailyShorts') }}"><i class="fa fa-ban"></i> <span> نواقص المبيعات
                                        اليومية</span></a></li>

                            <li><a href="{{ route('expReport') }}"><i class="fa fa-file-pdf-o"></i> <span>تقارير
                                        المنصرفات </span></a></li>


                            <li><a href="{{ route('currency') }}"><i class="fa fa-usd"></i> <span>العملة</span></a>
                            </li>


                            <li><a href="{{ route('users') }}"><i class="fa fa-users"></i> <span>المستخدمين</span></a>
                            </li>

                            <hr style="display: flex; width:100%; border: 1px solid">


                            <li><a href="{{ route('transactions') }}"><i class="fa fa-exchange"></i>
                                    <span>العهد</span></a></li>
                        @else
                            <li><a href="{{ route('shipments') }}"><i class="fa fa-tasks"></i>
                                    <span>الإرساليات</span></a></li>
