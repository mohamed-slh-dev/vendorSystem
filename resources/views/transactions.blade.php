                    ...
                    <table class="table mb-4">
                        ...
                        <tbody>
                            ...
                            <tr >
                                ...
                                <td style="width: 10%">
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample-{{$client->id}}" aria-expanded="false" aria-controls="collapseExample-{{$client->id}}">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success client-id" data-toggle="modal" data-target="#new-trans" value="{{$client->id}}">اضافة معاملة جديدة </button>

                                </td>

                                <td>

                                    <button class="btn btn-info" data-toggle="modal" data-target="#update-client-{{$client->id}}" > تعديل بيانات العميل </button>
                          ...
                          @endif
                            ...
                            <tr >
                                ...
                                <td style="width: 15%">
                                    ...
                                    @if ($trans->type ==  'له')
                                    <i style="font-weight: bold; font-size:18px;" class="text-success fa fa-arrow-up"></i>
                                    @else
                                    <i style="font-weight: bold; font-size:18px;" class="text-danger fa fa-arrow-down"></i>
                                    @endif
              ...
              <form action="{{route('addClient')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mb-20">
                        ...
                        <input type="text" id="price" required name="price" min="0" step=".01"  class="form-control fraction-commas" >
                    </div>
            ...
            <div class="modal-body">
              <form action="{{route('updateTransaction')}}" method="POST">
                ...
                <div class="row">
                    <div class="col-sm-4 mb-20">
                        <label for="date"> التاريخ</label>
                        <input type="date" id="date" name="date" value="{{$trans->date}}" class="form-control" >
                    </div>
                    <div class="col-sm-4 mb-20">
                        <label for="price"> المبلغ</label>
                        <input type="number" id="price" required name="price" value="{{$trans->price}}" min="0" step=".01"  class="form-control" >
                    </div>

                    <div class="col-sm-12 mb-20">
                        <label for="desc"> التفاصيل</label>
                        <input type="text" required id="desc" name="desc" value="{{$trans->desc}}" class="form-control" >
                    </div>
