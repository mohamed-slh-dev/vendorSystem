...
<div class="row">
    ...
    <div class="col-12">
        ...
        <button class="button button-primary" data-toggle="modal" data-target="#exampleModal1">اضافة ملاحظة </button>
    </div>
              ...
              <form action="{{route('addNote')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mb-20">
                        ...
                        <input type="number" required id="quantity" min="0" name="b_quantity[]" class="form-control" >
                    </div>

                    <div class="col-sm-12 mb-20">
                        <label for="desc"> ملاحظات</label>
                        <input type="text" id="desc" name="b_desc[]" class="form-control" >
                    </div>
              ...
              <form action="{{route('updateNote')}}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 mb-20">
                        ...
                        <input type="number" required id="remaining_quantity" name="remaining_quantity" value="{{$note->remaining_quantity}}" class="form-control" >
                    </div>
